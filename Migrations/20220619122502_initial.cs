    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    LoverID = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Fname = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    EMail = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Lovers", x => x.LoverID);
                });
            ...
            migrationBuilder.CreateTable(
                name: "FoodIntakeCounters",
                columns: table => new
                {
                    RecordId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    LoverID = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    NumberOfMealsOfFood = table.Column<int>(type: "int", nullable: false),
                    LastFoodEatenDateTime = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FoodIntakeCounters", x => x.RecordId);
                    table.ForeignKey(
